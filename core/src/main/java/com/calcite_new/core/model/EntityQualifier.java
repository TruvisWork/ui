...
public class EntityQualifier {
  ...
  public EntityQualifier(List<String> qualifiers, List<String> defaultQualifiers, Dialect dialect, EntityKind entityKind) {
  ...
  private List<Identifier> initQualifiers() {
    int supportedQualificationLevels = dialect.supportedQualificationLevels();
  ...
  public String toString() {
    return "EntityQualifier" + fullQualifiers + " [kind=" + entityKind + "]";
  }
}
