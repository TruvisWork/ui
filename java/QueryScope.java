...
public class QueryScope {
    ...
    // Set of available table/view identifiers in this scope
    private final Set<SqlIdentifier> availableTables = new HashSet<>();
    ...
    /**
     * Gets all subquery aliases in this scope.
     */
    public Set<String> getSubqueryAliases() {
        return new HashSet<>(subqueryInfoMap.keySet());
    }
    ...
    public Set<SqlIdentifier> getAvailableTables() {
        return new HashSet<>(availableTables);
    }
