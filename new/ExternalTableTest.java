...
class ExternalTableTest {
    ...
    void testExternalTableConstruction() {
        ...
        List<Column> columns = Arrays.asList(
            Column.builder()
                .name(Identifier.of("id", dialect))
                .dialect(dialect)
                .ordinalPosition(0)
                .type(DataType.create(SqlTypeName.INTEGER))
                .build(),
            Column.builder()
                .name(Identifier.of("name", dialect))
                .dialect(dialect)
                .ordinalPosition(1)
                .type(DataType.create(SqlTypeName.VARCHAR, 50))
                .build()
        );
    ...
    void testExternalTableImplementsRelationalEntity() {
        ...
        ExternalTable table = new ExternalTable(
            ...
            Arrays.asList(Column.builder()
                .name(Identifier.of("col", dialect))
                .dialect(dialect)
                .ordinalPosition(0)
                .type(DataType.create(SqlTypeName.VARCHAR, 10))
                .build()),
